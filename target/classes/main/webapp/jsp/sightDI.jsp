...
<div class="content">
    <!-- header -->
    <div class="header">
        <h1 class="page-title">旅游景点信息统计</h1>
    </div>
    <!-- highchat show -->
    ...
    <script language="JavaScript">
        $(document).ready(function () {
            ...
            var xAxis = {
                categories: [<c:forEach items="${tourPage}" var="sightDI"> '${sightDI.name}', </c:forEach>],
            ...
            var series = [{
                name: '人数：（/人)）',
                data: [<c:forEach items="${tourPage}" var="sightDI"> ${sightDI.number}, </c:forEach>]
            }, {
                name: '景点每日总消费（/元）',
                data: [<c:forEach items="${tourPage}" var="sightDI"> ${sightDI.number*100}, </c:forEach>]
            }
                // , {
                //     name: 'Year 2008',

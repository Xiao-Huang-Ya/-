...
<div class="sidebar-nav">
    ...
    <ul id="dashboard-menu" class="nav nav-list collapse">
        ...
        <li><a href="/hello/queryPassengerByPageServlet/1">旅游景区管理</a></li>
...
<div class="content">
    ...
    <div class="well">
        ...
        <div class="center-block" style="width:350px;background-color:rgba(0,0,0,0)">
            <button class="btn btn-primary" data-toggle="modal" data-target="#myAddPassengerModal">
                添加旅客
            </button>
            <!-- 模态框（Modal） -->
            <div class="modal fade" id="myAddPassengerModal" tabindex="-1" role="dialog"
                 aria-labelledby="myAddPassengerModal"
                 aria-hidden="true">
        ...
        <table class="table table-hover table-striped">
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="/hello/deletePassengerServlet/${list.pid}" role="button" data-toggle="modal"
            ...
            <ul>
                ...
                <c:choose>
                    <c:when test="${tourPage.totalCount <= tourPage.pageSize}">
                        <li><a href="/hello/queryPassengerByPageServlet/1">首页</a></li>
                        <li><a href="/hello/queryPassengerByPageServlet/${tourPage.totalPage}">尾页</a></li>
                    </c:when>
                    <c:when test="${tourPage.currentPage == 1}">
                        <li class="disabled"><a>首页</a></li>
                        <li><a href="/hello/queryPassengerByPageServlet/${tourPage.currentPage+1}">下页</a></li>
                        <li><a href="/hello/queryPassengerByPageServlet/${tourPage.totalPage}">尾页</a></li>

                    </c:when>
                    <c:when test="${tourPage.currentPage == tourPage.totalPage}">
                        <li><a href="/hello/queryPassengerByPageServlet/1">首页</a>
                        <li><a href="/hello/queryPassengerByPageServlet/${tourPage.currentPage-1}">上页</a></li>

...
<div class="sidebar-nav">
    ...
    <ul id="dashboard-menu" class="nav nav-list collapse">
        ...
        <li><a href="/hello/distrubutionGuideShowServlet/1">旅游景区管理</a></li>
        ...
        <table class="table table-hover table-striped">
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="/hello/distrubutionGuideServlet/${list.pid}" role="button" data-toggle="modal" class="btn btn-primary">分配导游</a>
            ...
            <ul>
                ...
                <c:choose>
                    <c:when test="${tourPage.totalCount <= tourPage.pageSize}">
                        <li><a href="/hello/distrubutionGuideShowServlet/1">首页</a></li>
                        <li><a href="/hello/distrubutionGuideShowServlet/${tourPage.totalPage}">尾页</a></li>
                    </c:when>
                    <c:when test="${tourPage.currentPage == 1}">
                        <li class="disabled"><a>首页</a></li>
                        <li><a href="/hello/distrubutionGuideShowServlet/${tourPage.currentPage+1}">下页</a></li>
                        <li><a href="/hello/distrubutionGuideShowServlet/${tourPage.totalPage}">尾页</a></li>

                    </c:when>
                    <c:when test="${tourPage.currentPage == tourPage.totalPage}">
                        <li><a href="/hello/distrubutionGuideShowServlet/1">首页</a>
                        <li><a href="/hello/distrubutionGuideShowServlet/${tourPage.currentPage-1}">上页</a></li>
